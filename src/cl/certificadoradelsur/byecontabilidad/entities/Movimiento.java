...
@NamedQueries({
		...
		@NamedQuery(name = "Movimiento.getAllFecha", query = "SELECT m  from Movimiento m where m.empresa.id = :idEmpresa and m.cuenta.banco.id = :idBanco and m.fecha between :fechaI and :fechaF  "),
